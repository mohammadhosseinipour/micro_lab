...
_0x20000:
	.DB  0x73,0x6E,0x73,0x72,0x25,0x64,0x3D,0x25
	.DB  0x64,0x6D,0x76,0x20,0x0,0x4F,0x43,0x52
	.DB  0x30,0x3D,0x25,0x64,0x0,0x6E,0x65,0x77
	.DB  0x5F,0x73,0x6E,0x73,0x72,0x25,0x64,0x3D
	.DB  0x25,0x64,0x6D,0x76,0x20,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 001B port_timer_lcd_init();
	RCALL _port_timer_lcd_init
; 0000 001C 
; 0000 001D sub1_sub3_init();
	RCALL _sub1_sub3_init
; 0000 001E sub1();
	RCALL _sub1
; 0000 001F sub2_init();
	RCALL _sub2_init
...
; 0001 00C4 sub2(input_index,ADCW);
	LDS  R30,_input_index_S0010007000
	ST   -Y,R30
	IN   R30,0x4
	IN   R31,0x4+1
	MOVW R26,R30
...
; 0001 00C9 if (++input_index > (LAST_ADC_INPUT-FIRST_ADC_INPUT))
	LDS  R26,_input_index_S0010007000
	SUBI R26,-LOW(1)
	STS  _input_index_S0010007000,R26
	CPI  R26,LOW(0x8)
	BRLO _0x2000B
; 0001 00CA    input_index=0;
	LDI  R30,LOW(0)
	STS  _input_index_S0010007000,R30
